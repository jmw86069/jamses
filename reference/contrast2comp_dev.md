...
#> (01:54:02) 30Aug2026: contrast2comp_dev(): ilist:
#> $`(A_c-B_c)-(A_d-C_d)`
#> [1] ""    "A_c" "B_c" "A_d" "C_d"
#> 
#> (01:54:02) 30Aug2026: contrast2comp_dev(): idf:
#>                                        C                   B A.1 A.2 split1
...
#> (A_c-B_c)-(A_d-C_d)4           B
#> (A_c-B_c)-(A_d-C_d)5           B
#> (01:54:02) 30Aug2026: contrast2comp_dev(): idf_new:
#>                     C                   B A.1 A.2 split2
#> A (A_c-B_c)-(A_d-C_d) (A_c-B_c)-(A_d-C_d) A-B   c      1
#> B (A_c-B_c)-(A_d-C_d) (A_c-B_c)-(A_d-C_d) A-C   d      1
#> (01:54:02) 30Aug2026: contrast2comp_dev(): idf_newer:
#>                                       C                   B     A.1 A.2
#> (A_c-B_c)-(A_d-C_d) (A_c-B_c)-(A_d-C_d) (A_c-B_c)-(A_d-C_d) A-B-A-C c-d
#> (01:54:02) 30Aug2026: contrast2comp_dev(): two-way imbalance:
#>   A.1   A.2 
#>  TRUE FALSE 
#> (01:54:02) 30Aug2026: contrast2comp_dev(): idf_newer:
#>                         C                      B A.1 A.2                newB
...
#> (01:54:02) 30Aug2026: im:
#>      [,1] [,2]
#> [1,] "A"  "c" 
#> [2,] "B"  "c" 
#> [3,] "A"  "d" 
#> [4,] "C"  "d" 
#> (01:54:02) 30Aug2026: imnew:
#>      [,1]  [,2]
#> [1,] "A-B" "c" 
#> [2,] "A-C" "d" 
#> [1] "(A-B:c)-(A-C:d)"
