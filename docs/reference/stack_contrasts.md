...
[`contrast2comp()`](contrast2comp.md) and
[`comp2contrast()`](contrast2comp.md). It takes a single vector of
groups, with 2^(integer) number of entries, and combines them into a
