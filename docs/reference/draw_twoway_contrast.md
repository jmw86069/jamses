...
- ...:
  ...
  [`make_block_arrow_polygon()`](make_block_arrow_polygon.md), including
  `arrow_ex` the arrow size expansion factor, and `head_ex` the arrow
  head expansion factor, which is adjusted relative to the arrow stem
  width.
...
#> (16:01:09) 10Aug2026: draw_twoway_contrast(): hand: right,right,right,left,left,right
#> (16:01:09) 10Aug2026: draw_twoway_contrast(): new_contrast_angles: 
